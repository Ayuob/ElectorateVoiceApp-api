...
import static ly.qubit.evp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import ly.qubit.evp.IntegrationTest;
import ly.qubit.evp.config.Constants;
import ly.qubit.evp.domain.User;
import ly.qubit.evp.repository.AuthorityRepository;
import ly.qubit.evp.repository.UserRepository;
import ly.qubit.evp.security.AuthoritiesConstants;
import ly.qubit.evp.service.UserService;
import ly.qubit.evp.service.dto.AdminUserDTO;
import ly.qubit.evp.service.dto.PasswordChangeDTO;
import ly.qubit.evp.service.dto.UserDTO;
import ly.qubit.evp.web.rest.vm.KeyAndPasswordVM;
import ly.qubit.evp.web.rest.vm.ManagedUserVM;
